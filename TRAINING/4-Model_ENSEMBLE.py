...
plt.savefig('Truepositive.pdf')
plt.close()

plt.hist(spectrograms_F_test_predict_ensemble)
plt.xlabel('Predicted Probability')
plt.ylabel('Count of Spectrograms')
plt.savefig('Truenegativee.pdf')
plt.close()
...
plt.xlabel('Predicted Probability')
plt.ylabel('Count of Spectrograms')
plt.savefig('Wrong_predicted.pdf')
plt.close()
...
plt.legend()
plt.savefig('ensamble_false_true.pdf')
plt.close()
...
plt.legend()
plt.savefig('ensamble_precision.pdf')
plt.close()
