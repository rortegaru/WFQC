...
model_history = model.fit(X_train, y_train, batch_size=12, epochs=15, verbose=1, validation_data=(X_validation, y_validation))
...
plt.savefig(model_dir+"Model_TrainHist_Accuracy_Densenet.pdf")
#plt.show()

# Save the weights
model.save_weights(model_dir + 'DenseNet121_weights_all_data.h5')

# Save the model architecture
with open(model_dir + 'DenseNet121_architecture_all_data.json', 'w') as f:
...
plt.savefig(model_dir+"HistDensenet.pdf")
...
plt.legend()
plt.savefig(model_dir+'True_Falsepositiv_Densenet.pdf',format='pdf')
...
plt.legend()
plt.savefig(model_dir+'Precision_Densenet.pdf', format='pdf')
