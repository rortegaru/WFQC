...
random.seed(40)
spectrograms_B_sample_index = sorted(random.sample(range(len(filenames_B)), 20000))
spectrograms_F_sample_index = sorted(random.sample(range(len(filenames_F)), 10000))
